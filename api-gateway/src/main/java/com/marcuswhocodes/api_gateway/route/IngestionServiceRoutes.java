...
public class IngestionServiceRoutes {
    ...
    public RouterFunction<ServerResponse> ingestionRoute() {
        return route("ingestion-service")
                ...
                .filter(CircuitBreakerFilterFunctions.circuitBreaker(
                        ...
                        URI.create("forward:/ingestionServiceFallbackRoute")
                ))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> ingestionServiceFallBackRoute() {
        return  route("ingestionServiceFallbackRoute")
                .route(RequestPredicates.path("/ingestionServiceFallbackRoute"),
                        request -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE)
                                .body("Ingestion Service Is Unavailable"))
                .build();
    }

    @Bean
    public RouterFunction<ServerResponse> ingestionServiceResponse(){
